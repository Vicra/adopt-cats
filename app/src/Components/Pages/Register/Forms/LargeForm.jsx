  ...
  return (
    <>
      <Form onSubmit={handleSubmit}>
        <h1>Nueva Cuenta</h1>
        <Row className="mb-3">
          <Form.Group as={Col} controlId="floatingName">
        ...
        <Row className="mb-3">
          <Form.Group as={Col} controlId="floatingPassword">
            <Password setField={setField} errors={errors} />
          </Form.Group>

          <Form.Group as={Col} controlId="floatingConfirmPassword">
            <Password
              setField={setField}
              errors={errors}
        ...
        <Form.Group className="mb-3" controlId="formAddress">
          <Address errors={errors} setField={setField} />
        </Form.Group>

        <Row className="mb-3">
          <Form.Group as={Col} controlId="formState">
            <State errors={errors} setField={setField} />
          </Form.Group>
        ...
        <Form.Control
          ...
          id="user_captcha_input2"
          name="user_captcha_input2"
          className="mb-3"
        />

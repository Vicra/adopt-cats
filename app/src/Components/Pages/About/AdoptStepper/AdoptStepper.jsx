...
export const AdoptStepper = () => {
  ...
  return (
    <Container>
      <CDBStepper
        direction={width < BREAK_POINT ? "vertical" : "horizontal"}
        showTitle={false}
        showTooltip={false}
      >
        <CDBStep
        ...
        <CDBStep
          id={2}
          name="LLena el formulario de adopción"
        ...
        <CDBStep
          id={3}
          name="Acepta los Terminos y Condiciones"
        ...
        <CDBStep
          id={4}
          name="Encuentrate con el dueño de la mascota"
...
const Step1 = () => {
  return (
    <>
      <h4>Crear Cuenta</h4>
      <p>
        Ve al formulario de para registrarte como un nuevo usuario, después de
        verificar tu usuario, inicia sesión y consulte por la mascota de su
        interés.
      </p>
    </>
  );
